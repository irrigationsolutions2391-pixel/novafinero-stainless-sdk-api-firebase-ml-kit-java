...
import com.novafinero_stainless_sdk_api_firebase_ml_kit.api.client.NovafineroStainlessSdkApiFirebaseMlKitClientImpl
...
/**
 * A class that allows building an instance of [NovafineroStainlessSdkApiFirebaseMlKitClient] with
 * [OkHttpClient] as the underlying [HttpClient].
 */
class NovafineroStainlessSdkApiFirebaseMlKitOkHttpClient private constructor() {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun fromEnv(): NovafineroStainlessSdkApiFirebaseMlKitClient = builder().fromEnv().build()
    }

    /** A builder for [NovafineroStainlessSdkApiFirebaseMlKitOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [NovafineroStainlessSdkApiFirebaseMlKitClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NovafineroStainlessSdkApiFirebaseMlKitClient =
