...
import com.novafinero_stainless_sdk_api_firebase_ml_kit.api.core.http.HttpRequestBody
import com.novafinero_stainless_sdk_api_firebase_ml_kit.api.core.http.HttpResponse
import com.novafinero_stainless_sdk_api_firebase_ml_kit.api.errors.NovafineroStainlessSdkApiFirebaseMlKitIoException
...
private constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw NovafineroStainlessSdkApiFirebaseMlKitIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
            ...
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(
                        NovafineroStainlessSdkApiFirebaseMlKitIoException("Request failed", e)
                    )
                }
            }
        )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("NOVAFINERO_STAINLESS_SDK_API_FIREBASE_ML_KIT_LOG")?.lowercase()) {
