 ...
 * asynchronously. You can also switch to synchronous execution via the [sync] method.
 *
 ...
 * may call [close].
 */
interface NovafineroStainlessSdkApiFirebaseMlKitClientAsync {
     ...
     * this client.
     */
    fun sync(): NovafineroStainlessSdkApiFirebaseMlKitClient
    ...
    /**
     * A view of [NovafineroStainlessSdkApiFirebaseMlKitClientAsync] that provides access to raw
