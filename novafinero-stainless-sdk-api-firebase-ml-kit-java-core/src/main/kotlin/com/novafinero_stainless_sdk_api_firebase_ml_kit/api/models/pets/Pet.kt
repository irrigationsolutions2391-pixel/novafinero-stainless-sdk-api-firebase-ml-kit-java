...
import com.novafinero_stainless_sdk_api_firebase_ml_kit.api.core.Enum
import com.novafinero_stainless_sdk_api_firebase_ml_kit.api.core.ExcludeMissing
...
import com.novafinero_stainless_sdk_api_firebase_ml_kit.api.core.checkKnown
import com.novafinero_stainless_sdk_api_firebase_ml_kit.api.core.checkRequired
import com.novafinero_stainless_sdk_api_firebase_ml_kit.api.core.toImmutable
...
private constructor(
    ...
    /**
     * @throws NovafineroStainlessSdkApiFirebaseMlKitInvalidDataException if the JSON field has an
     *   unexpected type or is unexpectedly missing or null (e.g. if the server responded with an
     *   unexpected value).
     */
    ...
    fun isValid(): Boolean =
        try {
            validate()
            true
        } catch (e: NovafineroStainlessSdkApiFirebaseMlKitInvalidDataException) {
            false
        }
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
         ...
         *
         * @throws NovafineroStainlessSdkApiFirebaseMlKitInvalidDataException if this class
        ...
        fun asString(): String =
            _value().asString().orElseThrow {
                NovafineroStainlessSdkApiFirebaseMlKitInvalidDataException("Value is not a String")
            }
    ...
    private constructor(
        ...
        /**
         * @throws NovafineroStainlessSdkApiFirebaseMlKitInvalidDataException if the JSON field has
         *   an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun id(): Optional<Long> = id.getOptional("id")
