...
import com.novafinero_stainless_sdk_api_firebase_ml_kit.api.client.okhttp.OkHttpClient
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw NovafineroStainlessSdkApiFirebaseMlKitRetryableException(
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            NovafineroStainlessSdkApiFirebaseMlKitRetryableException(
                                "Simulated retryable failure"
                            )
                        )
                        return future
