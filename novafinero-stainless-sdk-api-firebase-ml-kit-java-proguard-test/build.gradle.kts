plugins {
    id("novafinero-stainless-sdk-api-firebase-ml-kit.kotlin")
...
dependencies {
    testImplementation(project(":novafinero-stainless-sdk-api-firebase-ml-kit-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../novafinero-stainless-sdk-api-firebase-ml-kit-java-core/src/main/resources/META-INF/proguard/novafinero-stainless-sdk-api-firebase-ml-kit-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.novafinero_stainless_sdk_api_firebase_ml_kit.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../novafinero-stainless-sdk-api-firebase-ml-kit-java-core/src/main/resources/META-INF/proguard/novafinero-stainless-sdk-api-firebase-ml-kit-java-core.pro",
